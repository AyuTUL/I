// Lab 8.1: Write a program to read bookid, title, author and price of 10 books using structure and display detail of those books whose author is "Dinesh Khadka".
#include <stdio.h>
#include <string.h>
struct book
{
