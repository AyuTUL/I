// Lab 8.4: Write a program to read empid, name, post and salary of N employee using structure. And arrange the records according to alphabetical order of name field
#include <stdio.h>
#include <string.h>
struct employee
{
