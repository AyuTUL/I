// Lab 8.2: Write a program to read roll, name and marks in 5 subjects of N numbers of students using structure and find total marks and percentage and finally display details in tabular format
#include <stdio.h>
struct student
{
	int roll;
