// Lab 5.9: WAP to find roots of quadratic equation using function. Use function findroots() which receive three coefficient a,b,c of equation as arguments and display roots
#include <stdio.h>
#include <math.h>
