// Lab 6.3: Write a program to read empid, name, post and salary of N employee using structure. And display detail of those employee whose salary is between 40000 and 60000
#include <stdio.h>
struct employee
{
	int id;
